    ...
    <div className="wrap">
      <div className="split">
        <div className="split-copy reveal">
          ...
          <p className="lead">
            Typesense Cloud is a great managed option. But if you self-host, you
            shouldn't have to give up a real management UI. This dashboard is
            MIT-licensed, runs entirely client-side, and talks to your node
