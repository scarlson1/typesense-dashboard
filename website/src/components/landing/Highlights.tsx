        ...
        <div className='split'>
          ...
          <div className='split-media reveal d1'>
            ...
            {mode === 'light' ? (
              ...
              <img
                src='/assets/shots/search-dark.png'
                alt='Typesense Dashboard search interface with faceted results and query parameters'
              />
            )}
          </div>
        ...
        <div className='split flip'>
          <div className='split-copy reveal'>
            ...
            <p className='lead'>
              ...
              scan results spatially, with full documents one click away —
              powered by your own Mapbox token, stored locally.
            </p>
            <ul className='split-list'>
              <li>
                <CheckIcon />
              ...
              <li>
                <CheckIcon />
                <span>
                  <b>Works on mobile</b> — the whole dashboard is responsive
                  down to your phone.
                </span>
              </li>
            </ul>
